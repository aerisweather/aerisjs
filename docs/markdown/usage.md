...
For example, [`aeris.maps.layers.Radar`](/docs/public#aeris.maps.layers.Radar) can be found at [`aeris/maps/layers/radar`](https://github.com/hamweather/aerisjs/blob/master/src/maps/layers/aerisradar.js).

## Data and Weather API

The Aeris.js `api` library provides a javascript interface for interacting with data from the [Aeris API](http://www.hamweather.com/support/documentation/aeris/endpoints/). Data collection objects accept a [`params`](/docs/api/classes/aeris.api.params.models.Params.html) object, which is used to query the AerisAPI.
...
Data collections are populated via ajax requests, using the `fetch` method, which returns an [`aeris.Promise`](/docs/public#aeris.Promise) object.
...
| ----------------- |-------| -----------|
| `/earthquakes` | [`aeris.api.models.Earthquake`](/docs/public#aeris.api.models.Earthquake) | [`aeris.api.collections.Earthquakes`](/docs/public#aeris.api.collections.Earthquakes)|
| `/fires` | [`aeris.api.models.Fire`](/docs/public#aeris.api.models.Fire) | [`aeris.api.collections.Fires`](/docs/public#aeris.api.collections.Fires) |
| `/stormreports` | [`aeris.api.models.StormReport`](/docs/public#aeris.api.models.StormReport) | [`aeris.api.collections.StormReports`](/docs/public#aeris.api.collections.StormReports) |
...
[`Map`](/docs/public#aeris.maps.Map) objects are rendered and erased using the `setMap` method.
...
[`MarkerCollections`](/docs/public#aeris.maps.markercollections) can be used to render Aeris API data.
...
* [`Geolocation services`](/docs/public#aeris.geolocate)
* [`Geocode services`](/docs/public#aeris.geocode)
...
The Aeris [`AppBuilder`](/docs/api/classes/aeris.builder.maps.MapAppBuilder.html) is a dead-simple tool for creating a weather map application.
