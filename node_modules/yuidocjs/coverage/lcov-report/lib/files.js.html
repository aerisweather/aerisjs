...
<div class="header medium">
    ...
    <h2>
        ...
        Statements: <span class="metric">72.53% <small>(132 / 182)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">60% <small>(66 / 110)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">96.15% <small>(25 / 26)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">72.53% <small>(132 / 182)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
        function afterDestStat(err, stats) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (err &amp;&amp; err.code !== 'ENOENT') {
<span class="cstat-no" title="statement not covered" >                return callback(err);</span>
            }
&nbsp;
            if (stats) {
...
&nbsp;
        if (stats.isFile() || stats.isSymbolicLink()) {
            fs.unlinkSync(path);
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (stats.isDirectory()) {
            fs.readdirSync(path).forEach(<span class="fstat-no" title="function not covered" >function (filename) {</span>
...
&nbsp;
    ...
    **/
    function isSymbolicLink(path) {
        ...
        return stats ? stats.isSymbolicLink() : <span class="branch-1 cbranch-no" title="branch not covered" >false;</span>
    }
...
&nbsp;
                copyPath(from[0], to, true, function () {
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (isDirectory(from[1])) {
...
<span class="cstat-no" title="statement not covered" >                    writeFile.timer++;</span>
<span class="cstat-no" title="statement not covered" >                    Y.later(writeFile.timer, Y, writeFile, args);</span>
<span class="cstat-no" title="statement not covered" >                    return;</span>
                }
                cb();
            });
        } else {
<span class="cstat-no" title="statement not covered" >            out = fs.createWriteStream(file, flags);</span>
...
<span class="cstat-no" title="statement not covered" >                readFile.timer++;</span>
<span class="cstat-no" title="statement not covered" >                Y.later(readFile.timer, Y, readFile, args);</span>
<span class="cstat-no" title="statement not covered" >                return;</span>
            }
            cb(err, data);
        });
