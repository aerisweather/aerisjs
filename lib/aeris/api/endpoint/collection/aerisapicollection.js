define([
  ...
  'aeris/aerisapi'
], function(_, BaseCollection, Model, Params, Promise, JSONP, InvalidArgumentError, ApiResponseError) {
  /**
   ...
   * @param {aeris.AerisApi=} opt_options.AerisApi object used for fetching batch data.
   */
  var AerisApiCollection = function(opt_models, opt_options) {
     ...
     * @protected
     */
    this.params_ = (options.params instanceof Model) ?
                   options.params :
                   new Params(options.params, { validate: true });
   ...
   */
  AerisApiCollection.prototype.getQuery = function() {
