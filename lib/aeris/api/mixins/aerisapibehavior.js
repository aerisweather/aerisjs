define([
  ...
  return {
    ...
    removeFilter: function(filter) {
      this.params_.removeFilter(filter);
    },
     ...
     */
    resetFilter: function(opt_filter) {
      this.params_.resetFilter(opt_filter);
    },
    ...
    removeQuery: function(query) {
      this.params_.removeQuery(query)
    },
     ...
     */
    resetQuery: function(opt_query) {
      this.params_.resetQuery(opt_query);
    },
     ...
     *
     * @method getQuery
     * @return {aeris.api.params.collections.ChainedQuery}
     */
    getQuery: function() {
