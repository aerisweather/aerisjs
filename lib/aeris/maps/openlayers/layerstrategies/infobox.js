define(['aeris', 'base/layerstrategy'], function(aeris) {
  ...
  aeris.maps.openlayers.layerstrategies.InfoBox.prototype.createInstanceLayer =
    ...
    var icon = new OpenLayers.Icon(aeris.config.path +
        'assets/wx-details-marker.png', size, offset);
    ...
    popup.imageSrc = aeris.config.path + 'assets/wx-details-infobox-ol.png';
    return {
      popup: popup,
      markers: markers,
