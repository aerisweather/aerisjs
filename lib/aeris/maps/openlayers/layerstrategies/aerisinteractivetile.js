define([
  'aeris', 'aeris/aerisapi', 'aeris/events', './tile',
   ...
   */
  aeris.maps.openlayers.layerstrategies.AerisInteractiveTile.prototype.
      createAnimation = function(layer, map) {
    return new aeris.maps.openlayers.animations.
        AerisInteractiveTile(this, layer, map);
  };
