define([
   ...
   */
  var LayerStrategy = function(layer) {
    /**
     * @type {Boolean}
     * @private
  ...
  _.inherits(LayerStrategy, BaseLayerStrategy);


  /**
   * @method setMap
   */
  LayerStrategy.prototype.setMap = function(aerisMap) {
   ...
   */
  LayerStrategy.prototype.beforeRemove_ = function() {
   ...
   */
  LayerStrategy.prototype.updateOpacity_ = function() {
   ...
   */
  LayerStrategy.prototype.updateZIndex_ = function() {
