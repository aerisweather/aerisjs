define([
  'aeris/util',
  'base/layermanager',
  'openlayers/layerstrategies/osm',
  'openlayers/layerstrategies/tile',
  'openlayers/layerstrategies/aerisinteractivetile',
  'openlayers/layerstrategies/googlemaptype',
  'openlayers/layerstrategies/kml',
  'openlayers/layerstrategies/infobox',
  'openlayers/layerstrategies/aerispolygons'
],
function(_) {
  ...
  _.provide('aeris.maps.openlayers.LayerManager');
   ...
   *
   * @constructor
   * @class aeris.maps.openlayers.LayerManager
  ...
  _.inherits(aeris.maps.openlayers.LayerManager, aeris.maps.LayerManager);
