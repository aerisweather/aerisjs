define([
  ...
  'vendor/underscore',
  'gmaps/utils'
], function(aeris, MarkerStrategy, _, mapUtils) {
  ...
  aeris.maps.gmaps.markerstrategies.Icon.prototype.setMarker =
    ...
    this.bindMapEvents(aerisMarker, gMarker);
   ...
   */
  aeris.maps.gmaps.markerstrategies.Icon.prototype.bindMapEvents = function(aerisMarker, gMarker) {
