define([
  ...
  RouteRenderer.prototype.setStyles = function(styles) {
    var normalizedStyles = this.getNormalizedStyles_(styles);

    this.waypointStyles_ = normalizedStyles.waypoint;
    this.selectedWaypointStyles_ = normalizedStyles.selectedWaypoint;
    this.pathStyles_ = normalizedStyles.path;
    this.offPathStyles_ = normalizedStyles.offPath;
   ...
   * @private
   */
  RouteRenderer.prototype.getNormalizedStyles_ = function(options) {
