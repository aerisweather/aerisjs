...
define([
...
], function(aeris, _, InvalidArgumentError, BaseUnimplementedMethodError) {
  ...
  aeris.inherits(UnimplementedMethodError, InvalidArgumentError, BaseUnimplementedMethodError);
