define(['aeris',
  ...
  'gmaps/utils',
  'aeris/promise'
], function(aeris, APIResponseError) {
  ...
  aeris.maps.gmaps.route.commands.AddWaypointCommand.prototype.addWaypoint_ =
    ...
    if (!lastWaypoint || this.waypoint_.path) {
      ...
      this.waypoint_.setDistance(google.maps.geometry.spherical.
      ...
      route.done(function(response) {
        ...
        self.waypoint_.setDistance(response.routes[0].legs[0].distance.value);
