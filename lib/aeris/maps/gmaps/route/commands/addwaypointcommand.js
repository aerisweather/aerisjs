define(['aeris',
  ...
  aeris.maps.gmaps.route.commands.AddWaypointCommand.prototype.undo = function() {
    if (!this.canUndo) {
      throw new CommandHistoryError('Unable to undo command: command may not yet have been executed');
    }

    // Make sure execution is complete
    this.promise_.done(function() {
