...
define([
  ...
  aeris.maps.gmaps.route.commands.ResetRouteCommand.prototype.execute = function() {
    ...
    if (!this.refresh_) {
      ...
      this.addAllWaypoints_().
        done(this.promise_.resolve, this.promise_).
        fail(this.promise_.reject, this.promise_);
    }
