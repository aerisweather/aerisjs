define([
   ...
   * @private
   */
  aeris.maps.gmaps.route.Route.prototype.triggerChildChange_ = function(waypoint, eventObj) {
    if (eventObj && eventObj.properties) {
      _.each(eventObj.properties, function(prop) {
        this.trigger('change:' + prop, waypoint);
      }, this);
    }
