define([
  ...
  aeris.maps.gmaps.route.Route = function(opt_waypoints) {
    ...
    this.events_ = {
      ...
      'change:latLon': _.throttle(this.updatePaths, 800),
      'change:path': this.recalculateDistance,
      'change:followDirections': _.throttle(this.updatePaths, 800)
    };
   ...
   * @return {number}
   */
  aeris.maps.gmaps.route.Route.prototype.distanceTo = function(waypoint) {
    var distance = 0;
