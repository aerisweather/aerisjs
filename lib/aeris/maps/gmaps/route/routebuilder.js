define([
  ...
  aeris.maps.gmaps.route.RouteBuilder = function(opt_options) {
    ...
    this.routeEvents_ = {
      ...
      'change:position change:geocodedLatLon change:path change:selected': function(waypoint) {
   ...
   * @param {aeris.maps.gmaps.route.Waypoint=} opt_options.before
   *                                New waypoint will be inserted before this waypoint.
   *                                Can be used instead of 'at' option.
   *
