define([
  ...
  ImageMapType.prototype.getTile = function(coord, zoom, ownerDocument) {
    var img;
    var tileContainer = this.createTileContainer_(ownerDocument);
    var tileSrc = this.getTileUrl_(coord, zoom);

    if (!tileSrc || zoom < 1) { return tileContainer; }
