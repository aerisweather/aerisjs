define([
   ...
   * @override
   * @constructor
   * @class aeris.maps.gmaps.layerstrategies.AbstractMapTypeStrategy
   * @extends aeris.maps.gmaps.layerstrategies.AbstractLayerStrategy
   */
  ...
  _.inherits(AbstractMapTypeStrategy, BaseLayerStrategy);
  ...
  AbstractMapTypeStrategy.prototype.setMap = function(aerisMap, opt_options) {
    ...
    BaseLayerStrategy.prototype.setMap.call(this, aerisMap, options);
  ...
  AbstractMapTypeStrategy.prototype.undelegateMapEvents_ = function() {
    google.maps.event.clearInstanceListeners(this.mapView_);
  };
