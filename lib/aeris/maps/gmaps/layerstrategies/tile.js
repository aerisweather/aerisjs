define(['aeris', 'base/layerstrategy'], function(aeris) {
   ...
   */
  aeris.maps.gmaps.layerstrategies.Tile = function(aerisMap) {
   ...
   * @override
   */
  aeris.maps.gmaps.layerstrategies.Tile.prototype.setBaseLayer = function(layer) {
   ...
   * @override
   */
  aeris.maps.gmaps.layerstrategies.Tile.prototype.setLayer = function(layer) {
    this.ensureLayer_(layer);
   ...
   * @private
   */
  aeris.maps.gmaps.layerstrategies.Tile.prototype.ensureLayer_ = function(layer) {
   ...
   * @override
   */
  aeris.maps.gmaps.layerstrategies.Tile.prototype.showLayer = function(layer) {
   ...
   * @override
   */
  aeris.maps.gmaps.layerstrategies.Tile.prototype.hideLayer = function(layer) {
    var div = this.getDiv_(layer);
   ...
   * @return {Element}
   */
  aeris.maps.gmaps.layerstrategies.Tile.prototype.getDiv_ = function(layer) {
