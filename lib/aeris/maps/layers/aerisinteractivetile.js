define([
  ...
  AerisInteractiveTile.prototype.bindToApiKeys_ = function() {
   ...
   * @private
   */
  AerisInteractiveTile.prototype.ensureApiKeys_ = function() {
    this.set({
      apiId: this.get('apiId') || aerisConfig.get('apiId'),
      apiSecret: this.get('apiSecret') || aerisConfig.get('apiSecret')
    });
   ...
   */
  AerisInteractiveTile.prototype.loadTileTimes = function() {
    var TIMEOUT = 5000;
   ...
   * @private
   */
  AerisInteractiveTile.prototype.rejectAfterTimeout_ = function(promise, timeout, message) {
    _.delay(function() {
   ...
   * @private
   */
  AerisInteractiveTile.prototype.createTileTimesUrl_ = function() {
   ...
   * @private
   */
  AerisInteractiveTile.prototype.parseTileTimes_ = function(res) {
