define(['aeris'], function(aeris) {
   ...
   * @protected
   */
  aeris.maps.Map.prototype.layerManagerClass = aeris.abstractMethod;
   ...
   * @protected
   */
  aeris.maps.Map.prototype.eventManagerClass = aeris.abstractMethod;
   ...
   * @protected
   */
  aeris.maps.Map.prototype.markerManagerClass = aeris.abstractMethod;
   ...
   */
  aeris.maps.Map.prototype.initializedEvent = aeris.abstractMethod;
