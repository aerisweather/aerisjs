define([
  'aeris/util', 'aeris/events', 'aeris/promise', 'base/extension/mapextensionobject'
], function(_) {
  ...
  _.inherits(aeris.maps.Layer, aeris.maps.extension.MapExtensionObject);
  _.extend(aeris.maps.Layer.prototype, aeris.Events.prototype);
   ...
   */
  aeris.maps.Layer.prototype.clone = _.abstractMethod;
