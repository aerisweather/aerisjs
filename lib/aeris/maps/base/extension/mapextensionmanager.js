define(['aeris', './mapextension'], function(aeris) {
   ...
   */
   ...
   aeris.provide('aeris.maps.extension.MapExtensionManager');
  ...
  */
  ...
  aeris.inherits(aeris.maps.extension.MapExtensionManager,
   ...
   * @return {Object}
   */
  aeris.maps.extension.MapExtensionManager.prototype.getInstance =
      function(object) {
