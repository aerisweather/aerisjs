define([
   ...
   * @param {aeris.maps.layerstrategies.AbstractLayerStrategy|String} opt_options.strategy
  ...
  MapExtensionObject.prototype.initialize = function(attrs, options) {
    ...
    this.on('invalid', this.handleValidationError_, this);
   ...
   * @private
   */
  MapExtensionObject.prototype.handleValidationError_ = function(model, error) {
   ...
   */
  MapExtensionObject.prototype.remove = function() {
    // If no map has been set, do nothing
