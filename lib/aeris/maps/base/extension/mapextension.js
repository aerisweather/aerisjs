define([
  ...
  'base/abstractmap'
], function(_, InvalidArgumentError, MapInterface) {
  ...
  _.provide('aeris.maps.extension.MapExtension');
   ...
   *
   * @constructor
   * @class aeris.maps.extension.MapExtension
   * @param {aeris.maps.AbstractMap} aerisMap The aeris map to bind to for delegation.
