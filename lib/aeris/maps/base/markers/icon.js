define(['aeris', 'base/marker'], function(aeris) {
  ...
  aeris.maps.markers.Icon =
    ...
    // Enforce width and height properties
    if (!aeris.utils.isNumber(width) || !aeris.utils.isNumber(height)) {
      throw new Error("Invalid arguments: Icon requires a width and a height");
    }
