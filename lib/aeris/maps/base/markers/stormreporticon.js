define(['aeris/util', 'base/markers/icon'], function(_) {
  ...
  _.provide('aeris.maps.markers.StormReportIcon');
   ...
   * @constructor
   * @class aeris.maps.markers.StormReportIcon
  ...
  _.inherits(aeris.maps.markers.StormReportIcon, aeris.maps.markers.Icon);
  ...
  aeris.maps.markers.StormReportIcon.prototype.setCode = function(code) {
    ...
    if (this.urlCodes_[this.code_]) {
      this.url = _.config.path + 'assets/stormrep_marker_' +
