...
define([
   ...
   * @param {?string=} opt_options.clusterBy
  ...
  var PointDataMarkerCollection = function(opt_markers, opt_options) {
     ...
     */
    /**
     * When the `clusterBy` property
     * changes.
     *
     * @event change:clusterBy
     * @param {aeris.maps.markercollections.PointDataMarkerCollection} obj
     * @param {string} clusterBy
    ...
    /**
     * A reference to the model attribute
     * by which to cluster markers.
     * If specified, clusters will be created
     * for each value of the specified model attribute.
     * If null, clustering will happen in bulk for
     * all markers in the collection.
     *
     * The reference is a dot-notated string, representing
     * a property of the JSONified model.
     *
     * @type {?string}
     * @private
     */
    this.clusterBy_ = options.clusterBy;
   ...
   * @return {?string}
   */
  PointDataMarkerCollection.prototype.getClusterBy = function() {
    return this.clusterBy_;
  };


  /**
   * @firest 'change:clusterBy'
   * @param {string} path
   */
  PointDataMarkerCollection.prototype.setClusterBy = function(path) {
    this.clusterBy_ = path;
    this.trigger('change:clusterBy', this, path, {});
  };
