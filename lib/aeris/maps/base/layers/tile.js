define(['aeris/util', 'base/layer'], function(_) {
  ...
  _.provide('aeris.maps.layers.Tile');
  ...
  _.inherits(aeris.maps.layers.Tile, aeris.maps.Layer);
   ...
   */
  aeris.maps.layers.Tile.prototype.getUrl = _.abstractMethod;
