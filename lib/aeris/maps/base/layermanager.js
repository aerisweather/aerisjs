define(['aeris'], function(aeris) {
  ...
  aeris.maps.LayerManager = function(aerisMap, options) {
    ...
    /**
     * A hash of instantiated layer instances.
     *
     * @type {Object<string,Object}
     * @private
     */
    this.layerInstances_ = {};
  ...
  aeris.maps.LayerManager.prototype.setBaseLayer = function(layer) {
    ...
    var instance = this.getLayerInstance(layer);
    if (!instance.layer) {
  ...
  /**
   * Get an implemented layer instance.
   *
   * @param {aeris.maps.Layer} layer The layer to get the layer instance for.
   * @return {Object}
   */
  aeris.maps.LayerManager.prototype.getLayerInstance = function(layer) {
    var instance = this.layerInstances_[layer.name];
    if (!instance) {
      instance = this.layerInstances_[layer.name] = {};
    }
    return instance;
  };
