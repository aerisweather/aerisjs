define(['aeris/util', 'aeris/promise', 'base/layeranimation'], function(_) {
  ...
  _.provide('aeris.maps.animations.AnimationSync');
   ...
   * @constructor
   * @extends {aeris.maps.LayerAnimation}
   */
  aeris.maps.animations.AnimationSync = function(layers) {
     ...
     *
     * @type {Array.<aeris.maps.LayerAnimation}
     * @private
     */
    this.animations_ = [];
  ...
  _.inherits(aeris.maps.animations.AnimationSync, aeris.maps.LayerAnimation);
