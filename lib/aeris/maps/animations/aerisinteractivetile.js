define([
  ...
  AerisInteractiveTileAnimation.prototype.loadAnimationLayers = function() {
    ...
    return this.animationLayerLoader_.load().
      done(this.setTimeLayers_, this).
      done(this.ensureTimeBounds_, this).
      done(this.hideAllLayers_, this).
      done(this.stop, this);
  };
  ...
  AerisInteractiveTileAnimation.prototype.ensureTimeBounds_ = function() {
    this.from_ || (this.from_ = Math.min.apply(null, this.times_));
    this.to_ || (this.to_ = Math.max.apply(null, this.times_));
    this.limit_ || (this.limit_ = this.times_.length);
  };
  ...
  AerisInteractiveTileAnimation.prototype.hideAllLayers_ = function() {
    _.invoke(this.timeLayers_, 'hide');
  };
  ...
  AerisInteractiveTileAnimation.prototype.getLayerIndex_ = function() {
    return this.times_.indexOf(this.currentTime_);
  };
