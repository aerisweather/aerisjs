define([
   ...
   */
  var AerisTileAnimation = function(layer, opt_options) {
  ...
  _.inherits(AerisTileAnimation, AbstractAnimation);
   ...
   */
  AerisTileAnimation.prototype.loadAnimationLayers = function() {
    this.baseLayer_.set({
   ...
   * @method next
   */
  AerisTileAnimation.prototype.next = function() {
   ...
   * @method previous
   */
  AerisTileAnimation.prototype.previous = function() {
   ...
   * @method goToTime
   */
  AerisTileAnimation.prototype.goToTime = function(time) {
    var nextLayer;
  ...
  AerisTileAnimation.prototype.getCurrentTime = function() {
   ...
   */
  AerisTileAnimation.prototype.getLoadProgress = function() {
   ...
   * @method remove
   */
  AerisTileAnimation.prototype.remove = function() {
    this.stop();
   ...
   * @method setOpacity
   */
  AerisTileAnimation.prototype.setOpacity = function(opacity) {
   ...
   * @method getTimes
   */
  AerisTileAnimation.prototype.getTimes = function() {
    return _.clone(this.times_);
  };


  AerisTileAnimation.prototype.bindLoadEvents_ = function() {
  ...
  AerisTileAnimation.prototype.setTimeLayers_ = function(timeLayers) {
   ...
   */
  AerisTileAnimation.prototype.updateTimeBounds_ = function() {
  ...
  AerisTileAnimation.prototype.getOrderedTimesFromLayers_ = function(timeLayers) {
  ...
  AerisTileAnimation.prototype.proxyEvent_ = function(target, eventName) {
  ...
  AerisTileAnimation.prototype.getLayerForTime_ = function(time) {
   ...
   */
  AerisTileAnimation.prototype.getClosestTime_ = function(targetTime) {
   ...
   * @method transition_
   */
  AerisTileAnimation.prototype.transition_ = function(oldLayer, newLayer) {
  ...
  AerisTileAnimation.prototype.hideAllLayersExcept_ = function(exceptLayer) {
  ...
  AerisTileAnimation.prototype.getCurrentLayer = function() {
    return this.getLayerForTime_(this.currentTime_);
  };


  AerisTileAnimation.prototype.getNextTime_ = function() {
    return this.isCurrentLayerLast_() ?
      this.times_[0] : this.times_[this.getLayerIndex_() + 1];
  };


  AerisTileAnimation.prototype.getPreviousTime_ = function() {
   ...
   */
  AerisTileAnimation.prototype.isCurrentLayerFirst_ = function() {
   ...
   */
  AerisTileAnimation.prototype.isCurrentLayerLast_ = function() {
   ...
   */
  AerisTileAnimation.prototype.getLayerIndex_ = function() {
  ...
  return _.expose(AerisTileAnimation, 'aeris.maps.animations.AerisinteractiveTile');
});
