define([
  ...
  /**
   * @typedef {Array.<aeris.maps.extensions.MapExtensionObject|string|Object>} MapObjectOptions
   *
   * MapExtensionObject options (eg. layers, markers) are defined as an
   * array of any mix of the following:
   *
   * - MapExtObject constructors, eg:
   *    [aeris.maps.layers.AerisSatellite, aeris.maps.layers.AerisRadar]
   * - The name of the MapExtensionObject class, eg:
   *    ['AerisSatellite', 'AerisRadar']
   * - An object, eg:
   *    {
   *      type: aeris.maps.layers.AerisSatellite  // or just 'AerisSatellite',
   ...
   *
   * If layer is referenced as a string,
   * will attempt to find the layer constructor
   * in the global aeris namespace.
   *
