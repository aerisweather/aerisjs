define([
  ...
  */
  ...
  GeosearchModule.prototype.renderControllers_ = function() {
    this.eventHub_.trigger('mapControls:ready', this.geolocateController_.render(), 'geolocation');
    this.eventHub_.trigger('mapControls:ready', this.geocodeController_.render(), 'geocode');
  };
