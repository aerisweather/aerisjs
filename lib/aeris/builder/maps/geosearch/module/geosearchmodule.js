define([
  ...
  */
  ...
  GeosearchModule.prototype.renderControllers_ = function() {
    this.eventHub_.trigger('mapControls:render', this.geolocateController_.render(), 'geolocation');
    this.eventHub_.trigger('mapControls:render', this.geocodeController_.render(), 'geocode');
  };
