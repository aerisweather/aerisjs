define({
  ...
  geosearchModule: {
    create: {
      module: 'ai/builder/maps/geosearch/modules/geosearchmodule',
      args: [
        {
  ...
  geolocateTemplate: { module: 'hbars!ai/builder/maps/geosearch/views/geolocate.html' },
  geosearchTemplate: { module: 'hbars!ai/builder/maps/geosearch/views/geocode.html' },

  geolocateController: {
    create: {
      module: 'ai/builder/maps/geosearch/controllers/geolocatecontroller',
      args: [
        {
          tagName: 'span',
  ...
  geocodeController: {
    create: {
      module: 'ai/builder/maps/geosearch/controllers/geocodecontroller',
      args: [
        {
          mapState: { $ref: 'mapState' },
          eventHub: { $ref: 'eventHub' },
