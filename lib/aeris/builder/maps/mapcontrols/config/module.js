define(
   ...
   */
  {
    ...
    mapControlsModule: {
      create: {
        module: 'ai/builder/maps/mapcontrols/module/mapcontrolsmodule',
        args: [{
    ...
    mapControlsController: {
      create: {
        module: 'ai/builder/maps/mapcontrols/controller/mapcontrolscontroller',
        args: [{
    ...
    mapControlsTemplate: { module: 'hbars!ai/builder/maps/mapcontrols/view/controls.html' },
