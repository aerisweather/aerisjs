define([
  ...
  MapAppBuilder.prototype.build = function() {
    ...
    /**
     * Todo: Having circular dependency issues
     * with App requiring modules, and modules requiring
     * app propreties (eg. layout).
     *
     * One solution would be to pass in modules
     * as a deferred context. Then we can load the modules,
     * set them on the mapApp, then start the mapApp.
     */
