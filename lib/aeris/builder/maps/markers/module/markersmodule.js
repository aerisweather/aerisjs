define([
   ...
   * @override
   */
  MarkersModule.prototype.processBuilderOptions_ = function(mapObjectOption) {
    // Get the parent processed object
    var mapObjectState = MapObjectModule.prototype.processBuilderOptions_.call(this, mapObjectOption);
