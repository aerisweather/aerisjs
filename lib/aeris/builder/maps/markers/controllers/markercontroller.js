define([
  'ai/util',
  'ai/builder/maps/core/controllers/mapobjecttogglecontroller',
  'ai/api/params/models/filter'
], function(_, MapObjectToggleController, Filter) {
  /**
  ...
  MarkerController.prototype.resetFilter_ = function(filters) {
    ...
    this.view_.getParams().resetFilter(filters, { operator: Filter.OR });
  };
