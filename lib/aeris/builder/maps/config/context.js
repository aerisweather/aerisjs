define([
...
], function(_, coreContext, mapAppContext, mapControlsContext, mapContext, markersContext, layersContext, infoPanelContext) {
  /**
  ...
  return _.extend({
      ...
      $plugins: [
        ...
        'application/plugin/events'
      ]
    },
    coreContext, mapAppContext, mapControlsContext, mapContext, markersContext, layersContext, infoPanelContext);
});
