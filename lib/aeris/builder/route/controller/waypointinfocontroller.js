define([
   ...
   * a waypoint.
   *
   * @class aeris.builder.route.controller.WaypointInfoController
  ...
  WaypointInfoController.prototype.render = function() {
    ...
    this.infoBox_ = new InfoBox({
      latLon: this.waypoint_.getLatLon(),
      content: this.el
    });
  ...
  WaypointInfoController.prototype.close = function() {
    this.infoBox_.setMap(null);
  };


  /**
   * Called when the {aeris.maps.InfoBox} layer closes.
   * Cleanup.
   * @private
   */
