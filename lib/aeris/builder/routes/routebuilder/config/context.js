...
define([
  'aeris/util',
  'aeris/config',
  'routeappbuilder/routebuilder/routepointinfo/config/context'
], function(_, config, routePointInfoContext) {
    return _.extend(
      routePointInfoContext,
      {
        routeBuilderModule: {
          create: {
        ...
        routeControlsController: {
          create: {
            ...
            args: [
              {
                tagName: 'section',
                template: { module: 'hbs!routeappbuilder/routebuilder/view/controls.html' },
            ...
            args: [
              {
                ...
                waypoint: {
                  url: config.get('path') + 'assets/polaris/markers/small/routepoint.png',
                  offsetX: 12,
                  offsetY: 36
                },
                selectedWaypoint: {
                  url: config.get('path') + 'assets/polaris/markers/small/routepoint_selected.png',
                  offsetX: 25,
                  offsetY: 36
                }
              }
        ...
        SaveRouteController: _.classFactorySpec({
          create: {
            module: 'routeappbuilder/routebuilder/controller/saveroutecontroller',
            args: [
              {
                template: {
                  module: 'hbs!routeappbuilder/routebuilder/view/saverouteform.html'
                },
                ui: {
