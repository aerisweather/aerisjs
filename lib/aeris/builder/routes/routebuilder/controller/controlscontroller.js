define([
   ...
   * Undo command
   */
  ControlsController.prototype.undoCommand = function() {
   ...
   * Redo command
   */
  ControlsController.prototype.redoCommand = function() {
   ...
   * @public
   */
  ControlsController.prototype.renderReturnRoute = function() {
    throw new Error('Return route functionality has not yet been implemented.');
  };
