define([
  ...
  var ControlsController = function(options) {
    ...
    this.bindUIEvent('click', 'undo', this.undo);
    this.bindUIEvent('click', 'redo', this.redo);
    this.bindUIEvent('click', 'clear', this.clearRoute);
    this.bindUIEvent('click', 'collapse', this.toggleShow);
    this.bindUIEvent('change', 'followDirections', this.toggleFollowDirections);
    this.bindUIEvent('change', 'latLonInputs', this.setStartingWaypoint);
    this.bindUIEvent('keydown', 'latLonInputs', this.handleLatLonKeyPress_);
