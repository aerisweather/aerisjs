define([
  ...
  'vendor/jquery',
  'vendor/marionette/layout',
  'vendor/marionette/region'
], function(_, InvalidArgumentError, $, Layout, Region) {
  /**
   *
   ...
   * @param {Object.<string, string>=} options.regions Named regions to add to the layout.
   * @param {Object.<string,Backbone.View>=} options.regionControllers A hash of controllers to render in regions.
   */
  var ControlsController = function(options) {
    ...
    // Listen to this
    this.listenTo(this, {
      'render': this.renderRegionControls_
    });
  ...
  _.inherits(ControlsController, Layout);
   ...
   *
   * @param {Marionette.View} controller
   * @param {string} regionName
   */
  ControlsController.prototype.showInRegion = function(controller, regionName) {
    if (!this[regionName] || !(this[regionName] instanceof Region)) {
  ...
  ControlsController.prototype.renderRegionControls_ = function() {
