define([
   ...
   *
   * @param {aeris.maps.AbstractLayer} layer The layer to listen for time updates.
   ...
   *
   * @param {aeris.maps.AbstractLayer} layer The layer to unsubscribe for time updates.
   ...
   *
   * @param {aeris.maps.AbstractLayer} layer The layer to start the auto-updating.
   * @private
   */
   ...
   * Get the times for a specific layer.
   *
   * @param {aeris.maps.AbstractLayer} layer The layer to get the times for.
   * @param {boolean=} opt_refresh Optionally force a refresh of the times.
   * @return {aeris.Promise}
   */
