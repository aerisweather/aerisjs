define([
  ...
  ListenToFacet.prototype.listenTo = function(target, topic, handler, transformer) {
    this.listener_.listenTo(target, topic, _.bind(function(var_params) {
      ...
      handler.apply(this.listener_, transformer(args));
    }, this))
  };
  ...
  return function() {
    return {
      facets: {
         ...
         *  });
         *
         *  talker.trigger('whisper', 'hello', 'there');
         *  // listener called with args: 'HELLO', 'THERE'
         *
         *
         ...
         *    listenTo: {
         *      targetObj: {
         *        topic: 'opt_transform | handler'     // where 'handler' is a method of listenerObj
         *      }
         *    }
         * }
         *
