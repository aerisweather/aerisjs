define([
  'ai/util',
  'ai/application/controllers/layoutcontroller',
  'hbars!ai/application/form/views/checkbox.html',
   ...
   * @param {aeris.application.form.models.Toggle} options.model Required.
