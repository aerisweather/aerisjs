define([
   ...
   *
   * @class ComboToggle
   * @namespace aeris.application.form.models
   * @extends aeris.application.form.models.Toggle
   *
   * @constructor
   * @override
   *
  ...
  var ComboToggle = function(opt_attrs, opt_options) {
     ...
     * @type {Array.<aeris.application.form.models.Toggle>}
     */
   ...
   *
   * @param {Array.<Toggle>|aeris.application.form.collections.ToggleCollection} toggles
   * @method addToggles
   */
