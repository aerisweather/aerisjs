define([
  ...
  'ai/application/form/collections/togglecollection',
  'ai/classfactory'
   ...
   * @extends aeris.application.form.collections.ToggleCollection
   *
   * @constructor
   * @override
   *
  ...
  /**
   * @return {aeris.application.form.collections.ToggleCollection}
