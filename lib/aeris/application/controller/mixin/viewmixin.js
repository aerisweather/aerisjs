define([
  ...
  var ViewMixin = {
     ...
     */
    bindUIEvent: function(topic, uiName, handler, opt_ctx) {
     ...
     * @private
     */
    delegateSingleEvent_: function(topic, opt_selector, handler, opt_ctx) {
      ...
      var eventBindingArgs = opt_selector.length ? argsWithSelector : argsWithoutSelector;

      this.$el.on.apply(this.$el, eventBindingArgs);
    },


    getEventScope_: function() {
