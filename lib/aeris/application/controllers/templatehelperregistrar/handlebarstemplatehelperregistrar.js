define([
   ...
   * @namespace aeris.application.controllers.templatehelperregistrar
   * @implements aeris.application.controllers.templatehelperregistrar.TemplateHelperRegistrarInterface
   *
   * @constructor
   * @override
   */
