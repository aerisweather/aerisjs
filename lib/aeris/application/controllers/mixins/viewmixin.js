define([
  ...
  'ai/application/controllers/templatehelperregistrar/handlebarstemplatehelperregistrar'
   ...
   * @param {aeris.application.controllers.templatehelperregistrar.TemplateHelperRegistrarInterface=} opt_options.templateHelperRegistrar
   * 
   * @constructor
   */
