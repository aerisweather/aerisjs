define(["aeris"], function(aeris) {
   ...
   */
  Map.prototype.apiMapClass = aeris.notImplemented('Map.apiMapClass');
   ...
   * @protected
   */
  Map.prototype.createMap = aeris.notImplemented('Map.createMap');
   ...
   */
  Map.prototype.mapOptionsClass = aeris.notImplemented('Map.mapOptionsClass');
   ...
   * @protected
   */
  Map.prototype.createOptions = function(map, options) {
   ...
   * @public
   */
  Map.prototype.toLatLon = aeris.notImplemented('Map.toLatLon');
